<template>
    <div class="bg-white py-4 px-4 md:px-6 flex justify-between items-center border-b border-gray-5">
        <div>
            ...
            <div class="hidden lg:block text-primary-100 font-semibold">
                EziHotel - Hệ thống quản trị khách sạn
            </div>
        </div>
        <div class="flex items-center gap-6">
            <a href="tel:024 35 683727" class="font-semibold">
                <i class="fas fa-phone-alt text-gray-100" /> <span class="hidden md:inline text-warning-100">024 35 683727</span>
            </a>
