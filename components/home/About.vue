<template>
    <section id="about" class="bg-second-100 pb-10 px-5 sm:px-0 relative z-10">
        <div class="relative sm:max-w-[72vw] mx-auto border-b-[2px] border-solid pb-3 pt-5 sm:pt-20 sm:mb-5 flex items-center gap-4">
            <div>
                <div class="block sm:hidden">
                    <a-popover placement="bottom">
                        ...
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="none"
                            class="relative text-3xl top-1 stroke-black-100"
                        ><path
                ...
                <h2 class="text-5xl mb-0">
                    Michimie | Menu
                </h2>
            </div>
        </div>
        <div class="relative sm:max-w-[72vw] mx-auto flex items-center gap-10 pt-20">
            <div class="w-[50%]">
                <svg
                    id="Layer_1"
                    fill="#000000"
                    viewBox="0 0 512.004 512.004"
                    class="w-full h-auto max-w-[550px] mr-auto"
                >
                    <g>
                        <g>
                            <path
                                d="M442.306,376.33c-3.58-2.429-8.454-1.497-10.885,2.085c-26.8,39.492-71.173,63.069-118.703,63.069
                    ...
                    <g>
                        <g>
                            <path
                                d="M464.038,302.59c-4.338-0.348-8.094,2.869-8.441,7.183c-1.211,15.041-4.777,29.711-10.598,43.599
                    ...
                    <g>
                        <g>
                            <path
                                d="M191.96,146.577h-55.992c-14.762,0-26.772-12.01-26.772-26.772c0-14.761,12.01-26.771,26.772-26.771h25.764
                    ...
                    <g>
                        <g>
                            <path
                                d="M218.303,0h-34.13c-4.329,0-7.837,3.509-7.837,7.837c0,4.328,3.508,7.837,7.837,7.837h34.129
                    ...
                    <g>
                        <g>
                            <path
                                d="M385.231,103.243h-62.227c-12.969,0-23.522-10.552-23.522-23.522c0-12.969,10.552-23.521,23.522-23.521h21.635
                    ...
                    <g>
                        <g>
                            <path
                                d="M476.162,278.106h-6.681c0.092-0.717,0.154-1.446,0.154-2.198c0.002-8.006-5.534-13.983-9.982-18.786
            ...
            <div class="flex-1 text-3xl font-semibold flex-col gap-15">
                <p>Du bist Liebhaber*in des feinen Ramen-Handwerks oder neugierige Geschmacksentdecker*in? Du kriegst von Nudeln niemals genug oder freust dich ganz einfach auf eine heiße Schüssel vollmundiger Aromen?</p>
                <p>Bei monkī モンキー servieren wir dir die Vielfalt der modernen Ramen Küche. Authentisch, einzigartig oder ganz neu gedacht. Wir kochen ausschließlich mit frischen, sorgfältig selektierten Zutaten aus der Region. Unsere Ramen Nudeln sind aus hochwertigem Bio-Mehl und natürlich selbst gemacht. Dazu reichen wir internationale Cocktails oder empfehlen dir gerne einen passenden Sake. Unser Interieur ist japanisch-modern und bildet ein harmonisches Setting für deinen entspannten Ramen Genuss.</p>
                <p>Schlürfen erwünscht!</p>
                <p>
                    Es ist nicht unhöflich zu schlürfen, sondern die traditionelle und beste Art deine Ramen Nudeln zu genießen. Die Nudeln kühlen auf Verzehrtemperatur – die Schüssel bleibt heiß.
                </p>
            </div>
        </div>
    </section>
